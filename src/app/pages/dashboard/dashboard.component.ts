...
@Component({
  ...
  standalone: true,
  imports: [ChartsalesbetweentwodatesComponent, DashboardSalesCardsComponent, DashboardLowStockComponent, CommonModule, TuiButton, TuiAppearance, TuiTable, TuiSegmented, TuiCardMedium, DashboardProductsMostSalesComponent, DashboardLowStockComponent, DashboardSalesCardsComponent],
